 ...
 * 消息页面里的出没列表
 */
public class MsgChuMoFragment extends BaseFragment {
    ...
    private BaseAdapter mAdapter = new BaseAdapter() {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            MessageItemSlideLayout view = (MessageItemSlideLayout) inflater.inflate(R.layout.chumo_list_item, parent, false);
